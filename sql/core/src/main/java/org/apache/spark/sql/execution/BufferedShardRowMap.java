...
public final class BufferedShardRowMap extends MemoryConsumer {
    ...
    public BufferedShardRowMap(TaskMemoryManager taskMemoryManager, long setId, int numShards,
        ...
        // load factor 0.5 ensure probing perf.
    ...
    public final class KeyValueBatch {
        ...
        public ManagedBuffer wrapKeysBuffer() {
            final int capacity = Long.BYTES + Integer.BYTES * (2 + numKeys) + sizeKeys;
            final ByteBuf buf = alloc.buffer(capacity);
            // (setId) (shardId) (keys num-fields) [(key length) (key)]
            buf.writeLong(setId);
            buf.writeInt(shard);
        ...
        private void append(Object kbase, long koff, int klen, int khash, //
            ...
            // (value length) (value) (next)
            final long valueRecordLength = uaoSize + vlen + 8L;
            ...
            if (hasKey) {
                ...
                sizeKeys += klen;
                // (key length) (key hash) (key) (next)
                final long keyRecordLength = (uaoSize * 2L) + klen + 8L;
    ...
    private final class KeyValuePage extends AbstractPage {
    ...
    private abstract class AbstractPage {
        protected final MemoryBlock page;
        protected final Object baseObject;
        protected final long baseOffset;

        private AbstractPage(MemoryBlock page) {
            this.page = page;
