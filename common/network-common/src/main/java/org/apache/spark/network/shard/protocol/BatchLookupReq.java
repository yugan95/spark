...
public class BatchLookupReq extends ShardLookupMessage {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
                ...
                .append("numFields", numFields)
                .append("keys data size", keysData.length)
                .toString();
    }
    ...
    public int encodedLength() {
        return Long.BYTES /* encoded length of setId */
                ...
                + Integer.BYTES /* encoded length of numFields */
                + Encoders.ByteArrays.encodedLength(keysData); /* encoded length of keysData */
    }
